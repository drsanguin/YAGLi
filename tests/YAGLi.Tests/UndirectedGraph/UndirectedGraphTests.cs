...
namespace YAGLi.Tests.UndirectedGraph
{
    ...
    public class UndirectedGraphTests
    {
        ...
        [Test]
        public void Equals_with_another_object_who_is_not_a_UndirectedGraph_should_return_false()
        {
            var graph = new UndirectedGraph<Vertex, Edge<Vertex>>(true, true);
        ...
        [Test]
        public void Equals_with_another_Undirectedgraph_who_has_a_different_value_for_property_AllowLoops_should_return_false()
        {
        ...
        [Test]
        public void Equals_with_another_Undirectedgraph_who_has_a_different_value_for_property_AllowParallelEdges_should_return_false()
        {
            var graph1 = new UndirectedGraph<Vertex, Edge<Vertex>>(true, true);
        ...
        [Test]
        public void Equals_with_another_Undirectedgraph_who_has_a_different_number_of_edges_should_return_false()
        {
        ...
        [Test]
        public void Equals_with_another_Undirectedgraph_who_has_different_edges_should_return_false()
        {
            var graph1 = new UndirectedGraph<Vertex, Edge<Vertex>>(
                true,
                true,
        ...
        [Test]
        public void Equals_with_another_Undirectedgraph_who_has_a_different_number_of_vertices_should_return_false()
        {
            var graph1 = new UndirectedGraph<Vertex, Edge<Vertex>>(
                true,
                true,
        ...
        [Test]
        public void Equals_with_another_Undirectedgraph_who_has_different_vertices_should_return_false()
        {
            var graph1 = new UndirectedGraph<Vertex, Edge<Vertex>>(
                true,
                true,
        ...
        [Test]
        public void Equals_with_another_Undirectedgraph_equal_to_the_first_should_return_true()
        {
            var graph1 = new UndirectedGraph<Vertex, Edge<Vertex>>(
                true,
                false,
        ...
        [Test]
        public void Equals_with_another_Undirectedgraph_equal_to_the_first_with_the_two_who_allow_parallel_edges_should_return_true()
        {
            var graph1 = new UndirectedGraph<Vertex, Edge<Vertex>>(
                true,
                true,
        ...
        [Test]
        public void GetHashCode_should_return_the_same_result_for_two_UndirectedGraph_who_are_equal()
        {
            var graph1 = new UndirectedGraph<Vertex, Edge<Vertex>>(
                true,
                true,
        ...
        [Test]
        public void GetHashCode_should_return_a_different_result_for_two_UndirectedGraph_who_are_not_equal()
        {
            var graph1 = new UndirectedGraph<Vertex, Edge<Vertex>>(
                true,
                true,
        ...
        [Test]
        public void ToString_should_return_the_expected_string()
        {
        ...
        [Test]
        public void NeighborsOf_with_a_null_vertex_should_return_an_empty_IEnumerable()
        {
            var graph = new UndirectedGraph<Vertex, Edge<Vertex>>(true, true);
            Vertex vertex = null;
        ...
        [Test]
        public void PathsToNeighborsOf_with_a_null_vertex_should_return_an_empty_IEnumerable()
        {
            var graph = new UndirectedGraph<Vertex, Edge<Vertex>>(true, true);
            Vertex vertex = null;
