...
namespace YAGLi.Tests.UndirectedGraph
{
    ...
    public class UndirectedGraphDefensiveCodeTests
    {
        ...
        [Test]
        public void UndirectedGraph_AddEdges_with_IEnumerable_should_filter_edges_with_null_vertices()
        {
            _newGraph = _originalGraph.AddEdges(EDGE_COLLECTION_WITH_EDGE_WITH_NULL_VERTEX);
        }

        [Test]
        public void UndirectedGraph_AddEdges_with_Array_should_filter_edges_with_null_vertices()
        {
        ...
        [Test]
        public void UndirectedGraph_AddEdgesAndVertices_with_IEnumerable_should_filter_edges_with_null_vertices()
        {
            _newGraph = _originalGraph.AddEdgesAndVertices(EDGE_COLLECTION_WITH_EDGE_WITH_NULL_VERTEX);
        }

        [Test]
        public void UndirectedGraph_AddEdgesAndVertices_with_Array_should_filter_edges_with_null_vertices()
        {
        ...
        [Test]
        public void UndirectedGraph_RemoveEdge_with_an_edge_with_null_vertices_should_return_the_same_instance()
        {
        ...
        [Test]
        public void UndirectedGraph_RemoveEdges_with_IEnumerable_should_filter_edges_with_null_vertices()
        {
            _newGraph = _originalGraph.RemoveEdges(EDGE_COLLECTION_WITH_EDGE_WITH_NULL_VERTEX);
        }

        [Test]
        public void UndirectedGraph_RemoveEdges_with_Array_should_filter_edges_with_null_vertices()
        {
        ...
        [Test]
        public void UndirectedGraph_RemoveEdgesAndVertices_with_IEnumerable_should_filter_edges_with_null_vertices()
        {
            _newGraph = _originalGraph.RemoveEdgesAndVertices(EDGE_COLLECTION_WITH_EDGE_WITH_NULL_VERTEX);
        }

        [Test]
        public void UndirectedGraph_RemoveEdgesAndVertices_with_Array_should_filter_edges_with_null_vertices()
        {
