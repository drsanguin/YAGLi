...
namespace YAGLi.Specs.UndirectedGraph.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("Retrieve a list of adjacent vertices from a undirected graph")]
    public partial class RetrieveAListOfAdjacentVerticesFromAUndirectedGraphFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Retrieve a list of adjacent vertices from a undirected graph", null, ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
            ...
            table3.AddRow(new string[] {
                        "v4"});
#line 22
 testRunner.Then("I get the vertices", ((string)(null)), table3, "Then ");
#line hidden
